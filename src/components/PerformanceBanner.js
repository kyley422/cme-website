...
const PerformanceBanner = () => {
    return (
        <>
            ...
            >
                <Flex height={{ base: "auto", md: "90%" }} width={{ base: "100%", md: "560px" }} marginLeft={{ base: "0", md: "5%" }}>
                    <Box flex="1" flexDirection="column" display="flex" justifyContent="flex-start" paddingTop="20px" marginLeft={{ base: "0", md: "5%" }}>
                        <Heading
