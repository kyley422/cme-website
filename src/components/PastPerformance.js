...
import { Box, Center, Flex, Grid, Heading, Image, Text, useColorModeValue} from '@chakra-ui/react'
...
const PastPerformance = () => {
  ...
  return (
    ...
    >
        ...
        bg={useColorModeValue('white', 'black')}
        >
            <Heading fontWeight="bold" fontSize={{ base: "2xl", md: "40px" }} textAlign="center">Past Performances</Heading>
        </Flex>
        ...
        >
          {past_performances.map((perf, idx) => (
            <Box key={idx} textAlign="center" maxWidth="300px" marginBottom={{ base: "20px", md: "0" }}>
              ...
              <Text fontWeight="medium" fontSize={{ base: "md", md: "20px" }} paddingTop="5px">{perf.name}</Text>
            </Box>
          ))}
        </Grid>
      </Box>
