            ...
            >
                ...
                <Flex display={{base: 'none', md: 'flex'}} height="10%" width="full" flexDirection={{base: "column", md: "row"}}>
                    ...
                    <Box width="40%" height="200px" display="flex" alignitems="center" justifyContent="flex-start" flexDirection="column" paddingLeft="10%">
                        <Button width={{base: "full", md: "430px"}} height="50px" backgroundColor="red.500" fontSize="18px" as="a" href="/instruments">Instruments Offered</Button>
                    </Box>
                </Flex>
                ...
                <Flex display={{ base: 'flex', md: 'none' }} height="10%" width="full" flexDirection="row" gap="30px" flexWrap="wrap">
                    ...
                    <Box display={{base: 'block', md: 'none'}} width="full" height="full" textAlign="center" alignitems="center" justifyContent="center" flexDirection="row" paddingLeft="0%" paddingBottom="10px">
                        <Button borderRadius="10px" width={{base: "85%", md: "430px"}} height="50px" margin="auto" backgroundColor="red.500" fontSize="14px" as="a" href="/instruments" padding="10px">Instruments Offered</Button>
                    </Box>
                </Flex>
            </Box>
        </>
