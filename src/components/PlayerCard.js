  ...
  return (
    ...
    >
        ...
        >
            ...
            marginRight="5%"
            >
                <Heading fontWeight="extrabold" mb="4" fontSize="32px">{player.name}</Heading>
                <Flex flexDir="row">
                    <Text fontWeight="bold" fontSize="20px">Year:&nbsp;</Text>
                    <Text fontWeight="normal" fontSize="20px">{player.year}</Text>
                </Flex>
                <Flex flexDir="row">
                    <Text fontWeight="bold" fontSize="20px">Major:&nbsp;</Text>
                    <Text fontWeight="normal" fontSize="20px">{player.major}</Text>
                </Flex>
                <Flex flexDir="row">
                    <Text fontWeight="bold" fontSize="20px">Years Played:&nbsp;</Text>
