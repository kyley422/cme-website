  ...
  return (
    ...
    >
        ...
        >
            ...
            >
                <Heading fontWeight="extrabold" mb="4" fontSize={{base: "30px", md: "64px"}}>About</Heading>
                <Text width={{base: "100%"}} fontWeight="normal" fontSize={{base: "16px", md: "18px"}}>
        ...
        >
            <Box width={{base: "100%", md: "45%"}} minWidth="300px">
                <Flex direction="row" gap="2">
                    <Image display={{base: "none", md: "block"}} src="https://res.cloudinary.com/dp0f6uqzo/image/upload/v1725505603/cme_chi_1_iidzh0.png" alt="Professor li" objectFit="cover" />
                    <Image boxSize={{base: "100%", md: "auto"}} justify="center" src="https://res.cloudinary.com/dp0f6uqzo/image/upload/v1725505603/cme_chi_2_mw4moh.png" alt="Professor li" objectFit="cover" />
                </Flex>
            </Box>
            ...
            >
                <Heading as="h1" size="xl" mb="4" fontSize={{base: "30px", md: "36px"}}>Our Director</Heading>
                <Text fontSize="md">
